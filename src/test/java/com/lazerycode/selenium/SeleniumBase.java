...
public class SeleniumBase {
    ...
    private static DesiredCapabilities generateDesiredCapabilities(BrowserType capabilityType) {
        ...
        switch (capabilityType) {
            case IE:
                ...
                capabilities.setCapability(InternetExplorerDriver.IE_SWITCHES, "-private"); //always launch in private mode
                break;
            case SAFARI:
        ...
        browserVersion = _prop.getString("version");
        if (browserVersion.equals("0")) {
            //do nothing
        } else {
    ...
    private static WebDriver loadWebDriver() {
        ...
        System.out.println("Current Browser Selection: " + browserType + " " + browserVersion);
